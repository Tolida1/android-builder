...
public class PlayerActivity extends Activity {
    ...
    private TextView    timeTv, scaleTv, playTv;
    ...
    private void buildLayout(final String title) {
        ...
        // Controls overlay
        controlsOverlay = buildControls(title);
        root.addView(controlsOverlay, new FrameLayout.LayoutParams(-1, -1));
    ...
    private View buildControls(String title) {
        ...
        scaleTv.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) { cycleScale(); scheduleHide(); }
        });
        ...
        final String[] spLabels= {"0.5x","0.75x","1x","1.25x","1.5x","2x"};
        final int[] spIdx      = {2};
        final TextView speedTv = ctrlBtn("1x");
        speedTv.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                spIdx[0] = (spIdx[0] + 1) % speeds.length;
                currentSpeed = speeds[spIdx[0]];
                speedTv.setText(spLabels[spIdx[0]]);
        ...
        lockTv.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                locked = !locked;
        ...
        btnRow.addView(rw);
        btnRow.addView(playTv);
        btnRow.addView(fw);
        btnRow.addView(speedTv);
        btnRow.addView(scaleTv);  // also in bottom for easy access
        btnRow.addView(zoomReset);
        btnRow.addView(lockTv);
    ...
    private void buildPlayer(String url, String referer, String origin) {
        ...
        // DefaultHttpDataSource ile header ekle (OkHttp gerekmez, crash olmaz)
        ...
        player.addListener(new Player.Listener() {
            ...
            public void onPlayerError(PlaybackException error) {
                Toast.makeText(PlayerActivity.this,
                    "Oynatma hatası: " + error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
